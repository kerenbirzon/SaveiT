...
//    }
    ...
    public void checkUserExists() {
        ...
        if (inputUserName.isEmpty() || inputPassword.isEmpty()){
            ...
            Toast.makeText(getContext(),"passwords dosent match",Toast.LENGTH_SHORT).show();
        }else if (!inputUserName.matches(emailPattern)){
            Toast.makeText(getContext(),"email must be validate",Toast.LENGTH_SHORT).show();
        }else {
